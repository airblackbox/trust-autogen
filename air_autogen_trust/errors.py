"""
air-autogen-trust — Custom Exceptions

AutoGen hooks can raise exceptions to halt execution.
These custom exceptions provide structured error information
for trust layer violations.
"""
